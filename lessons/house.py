...
class House:
    def __init__(self, window_size, foundation_type, roof_style, door_color):
...
class Condo(House):
    ...
    def __init__(self, window_size, foundation_type, roof_style, door_color, balcony):
        super().__init__(window_size, foundation_type, roof_style, door_color)
