...
# elif example
# Used when the first condition is false
# and you want to try another
...
# else statement
# This keyword can be used to execute a block of code when
# the if results are false
...
# The inner if statement only evaluates of the outer if is true.
happy = 14
...
print('both are equal' if golf == hotel else 'golf is greater'
      if golf > hotel else 'hotel is greater')
...
def combined(arg1, arg2, arg3):
    if arg1 > arg2 and arg1 >= arg3:
        print('argument 1 is the greater')
