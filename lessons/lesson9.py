...
# using *args and **kwargs will help define this argument
...
# The arguments we pass into te function as a tuple, when executed create
...
# Using the default argument allows you  to have more than one, with on
